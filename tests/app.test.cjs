...
assert.strictEqual((pv.match(/fill="#F97316"/g)||[]).length, 183); ok('grid desenha 183 blocos de etiqueta');
assert.ok(pv.includes('cada bloco = 1 etiqueta')); ok('legenda do grid');
els['largura'].value = '0';
calcularRendimento();
